// PIC32MZ_8.c - Timers and Interrupts on the PIC32MZ
// by Aidan Mocke 2018-11-15
// I've switched to using the internal FRC as the clock source instead of an external crystal
//
...
int main()
{
	...
	// Initialise the timer 2 interrupt at 1000Hz
    // This will cause pin RH0 to be toggled 1000 times / second
	init_timer2(1000);
	
    while (1)
    {
        // Loop endlessly, doing nothing and letting the interrupt do it all
    }                
}