// PIC32MZ_2.c - A simple PIC32MZ skeleton
// by Aidan Mocke 2018-04-09
//
...
{
    ms *= (SYS_FREQ / 1000 / 2 / 32); // /2 due to PB_clock being DIV_2
    
    T8CON = 0;
    T9CON = 0;
    PR8 = (delay & 0xFFFF); // Low word in PR8
    PR9 = (delay >> 16); // High word in PR9
    T8CON = 0x8008;  // Bit 15 = timer enable, bit 3 = 32-bit mode on
    
    TMR8 = 0;
    TMR9 = 0;
    while (TMR9 < (delay >> 16)); // Delay ms milliseconds	
}
